...
if mdb.models.has_key('TaperModelCurve'):
  del mdb.models['TaperModelCurve']

taperModel = mdb.Model(name='TaperModelCurve')
...
mdb.Job(atTime=None, contactPrint=OFF, description='', echoPrint=OFF,
  ...
  memory=90, memoryUnits=PERCENTAGE, model='TaperModelCurve', modelPrint=OFF,
  multiprocessingMode=DEFAULT, name='TaperModelCurve', nodalOutputPrecision=SINGLE,
