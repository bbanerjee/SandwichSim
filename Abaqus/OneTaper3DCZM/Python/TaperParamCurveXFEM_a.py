...
if mdb.models.has_key('TaperModelCurveXFEM_a'):
  del mdb.models['TaperModelCurveXFEM_a']

taperModel = mdb.Model(name='TaperModelCurveXFEM_a')
...
mdb.Job(atTime=None, contactPrint=OFF, description='', echoPrint=OFF,
  ...
  memory=90, memoryUnits=PERCENTAGE, model='TaperModelCurveXFEM_a', modelPrint=OFF,
  multiprocessingMode=DEFAULT, name='TaperModelCurveXFEM_a', nodalOutputPrecision=SINGLE,
