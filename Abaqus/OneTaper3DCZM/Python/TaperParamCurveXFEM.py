...
if mdb.models.has_key('TaperModelCurveXFEM'):
  del mdb.models['TaperModelCurveXFEM']

taperModel = mdb.Model(name='TaperModelCurveXFEM')
...
mdb.Job(atTime=None, contactPrint=OFF, description='', echoPrint=OFF,
  ...
  memory=90, memoryUnits=PERCENTAGE, model='TaperModelCurveXFEM', modelPrint=OFF,
  multiprocessingMode=DEFAULT, name='TaperModelCurveXFEM', nodalOutputPrecision=SINGLE,
