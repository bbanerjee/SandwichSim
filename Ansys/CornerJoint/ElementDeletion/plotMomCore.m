function plotMom
  ...
  %-----------------------------------
  load MomEkillCore_Ins.dat
  sigtimeIns = MomEkillCore_Ins(:,3);
  sigvalIns = MomEkillCore_Ins(:,4);
  numElIns = MomEkillCore_Ins(1,1);
  ...
  %-----------------------------------
  load MomEkillCore_Adh.dat
  sigtimeAdh = MomEkillCore_Adh(:,3);
  sigvalAdh = MomEkillCore_Adh(:,4);
  numElAdh = MomEkillCore_Adh(1,1);
  ...
  %-----------------------------------
  load MomEkillCore_CoreC.dat
  sigtimeCoreC = MomEkillCore_CoreC(:,3);
  sigvalCoreC = MomEkillCore_CoreC(:,4);
  numElCoreC = MomEkillCore_CoreC(1,1);
  ...
  %-----------------------------------
  load MomEkillCore_CoreS.dat
  sigtimeCoreS = MomEkillCore_CoreS(:,3);
  sigvalCoreS = MomEkillCore_CoreS(:,4);
  numElCoreS = MomEkillCore_CoreS(1,1);
  ...
  %-----------------------------------
  load MomEkillCore_FaceC.dat
  sigtimeFaceC = MomEkillCore_FaceC(:,3);
  sigvalFaceC = MomEkillCore_FaceC(:,4);
  numElFaceC = MomEkillCore_FaceC(1,1);
